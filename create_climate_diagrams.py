...
src = Path("/Volumes/Frauke/Uni/Semester02/Python/exercise-4-Drieschf/")
data = src / "data/"
output = src / "output/"
...
zugspitze  =  pd.read_csv(data / "produkt_klima_tag_20171010_20190412_05792.txt", 
                          parse_dates = ["MESS_DATUM"], index_col = "MESS_DATUM", sep = ";", na_values = -999)
garmisch =  pd.read_csv(data / 'produkt_klima_tag_20171010_20190412_01550.txt', 
                        parse_dates = ["MESS_DATUM"], index_col = "MESS_DATUM", sep = ";", na_values = -999)
...
create_climate_diagram(garmisch, temp_col = ' TMK', prec_col = ' RSK', 
                       title = "Climate Chart Garmisch 2018", filename = "output/Garmisch_output.png")
create_climate_diagram(zugspitze, temp_col = ' TMK', prec_col=' RSK', 
                       title= "Climate Chart Zugspitze 2018", filename = "output/Zugspitze_output.png")